...
function collapsedSummaryToken(mailbox: MailboxSidebarState, theme: MailboxSidebarTheme): MailboxTextToken {
  return {
...
function projectTokens(projects: readonly ProjectPresenceRow[], theme: MailboxSidebarTheme): readonly MailboxTextToken[] {
...
function projectDotColor(color: ProjectPresenceRow["dotColor"], theme: MailboxSidebarTheme): TuiColor | undefined {
  switch (color) {
    case "success":
