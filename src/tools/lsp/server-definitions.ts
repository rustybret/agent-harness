...
export const LSP_INSTALL_HINTS: Record<string, string> = {
  ...
  prisma: "brew tap prisma/prisma && brew install prisma",
  "ocaml-lsp": "opam install ocaml-lsp-server",
  texlab: "brew install texlab",
  dockerfile: "brew install dockerfile-language-server",
  gleam: "brew install gleam",
  "clojure-lsp": "brew install clojure-lsp",
...
export const BUILTIN_SERVERS: Record<string, Omit<LSPServerConfig, "id">> = {
  ...
  "ansible-ls": { command: ["ansible-language-server", "--stdio"], extensions: [".ansible.yml", ".ansible.yaml"] },
